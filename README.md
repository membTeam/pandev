...
- AWAITING_REMOVE_ELEMENT ожидание ввода идентификатора элемента удаляемого элемента  
...
- GroupsRepository   
  ...
  т.к. Hibernate не поддерживает некоторый нативные функционал postgresql
